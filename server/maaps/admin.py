...
class MachineAdmin(admin.ModelAdmin):
    list_display = ("id", "name", "comment", "ask_clean","ask_pay_material", "price_per_hour", "price_per_usage", "tutor_required_count", "tutor_required_once_after_month", "currentSession")
