...
urlpatterns = [
                  ...
                  path(r'machine/login_user/<user_token>', views.machine__login_user,
                       name='machine__login_user_with_parameter'),
                  ...
                  path(r'machine/other_user_pays', views.machine__other_user_pays,
                       name='machine__payment_other_user_pays'),
                  path(r'machine/auto_logout', views.machine__auto_logout, name='machine__auto_logout'),
                  path(r'machine/M:<machine_token>', views.machine__login_machine,
                       name='machine__login_with_parameter'),
...
'''
    path(r'machine/session/auto_logout'      , views.machine__session__auto_logout__timer, name='machine__session__auto_logout__timer'),
    path(r'machine/session/auto_logout/clock', views.machine__session__auto_logout__clock, name='machine__session__auto_logout__clock'),
    path(r'machine/session/auto_logout/timer', views.machine__session__auto_logout__timer, name='machine__session__auto_logout__timer'),
